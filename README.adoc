...
image::Harmonic_Dark.png[alt="Example skin: Harmonic Dark",align="center",width="600"]
image::Solarized_Light.png[alt="Example skin: Solarized Light",align="center",width="600"]
image::Isotope.png[alt="Example skin: Isotope",align="center",width="600"]
