...
Window -- (formerly Background) A general background color
WindowText --(formerly Foreground) A general foreground color
Base -- Background color for text entry widgets, background of combobox drop downs, toolbar handles, etc.. It is usually white or another light color.
AlternateBase -- Background color for alternating rows
Text -- The foreground color used with Base (usually the same as the WindowText)
ToolTipBase --  (from the Inactive color group!) Background color for QToolTip/QWhatsThis
ToolTipText --  (from the Inactive color group!) Foreground color for QToolTip/QWhatsThis
PlaceholderText -- Used as the placeholder color for various text input widgets.
Button -- Background for buttons.
...
HighlightedText -- Foreground color of highlighted text
Link -- Unvisited hyperlinks
LinkVisited -- Visited hyperlinks
