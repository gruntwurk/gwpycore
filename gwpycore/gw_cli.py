...
def basic_cli_parser(version_text: str = "", verbose=True, very_verbose=True, nocolor=True, filenames="", devel=False, trace=False, configfile=False, logfile=False, infile=False, outfile=False, recurse=False) -> ArgumentParser:
    """
